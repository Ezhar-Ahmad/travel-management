...
<div class="privacy" align="center">
	...
	<p style="width: 350px;">
			...
			<b>Current Password</b>  <br><input type="password" name="password" id="exampleInputPassword1" placeholder="Current Password" required="">
	</p> 
...
<b>Confirm Password</b><br>
	<input type="password" name="confirmpassword" id="confirmpassword" placeholder="Confrim Password" required="">
			...
			<p style="width: 350px;">
<button type="submit" name="submit5" class="bbtn">Change</button>
			</p>
